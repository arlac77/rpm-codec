= rpm-stream image:https://secure.travis-ci.org/rpm-stream/rpm-stream.org.png?branch=master["Build Status", link="https://travis-ci.org/rpm-stream/rpm-stream.org"]
