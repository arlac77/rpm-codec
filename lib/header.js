...
function readHeader(buf) {
  ...
  if (buf.length < MIN) {
    throw new TypeError(`Illegal header, expecting at least ${MIN} bytes`);
  }
  if (!buf.slice(0, 3).equal(headerStructureHeaderMagic)) {
    throw new TypeError("Bad magic, this is not a header");
  }
...
exports.num = num;
exports.types = types;
exports.readStoreValue = readStoreValue;
