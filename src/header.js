...
var readStoreValue = function(store, index) {
  ...
  } else if (type == types.CHAR || type == types.STRING || type == types.I18NSTRING || type == types.STRING_ARRAY) {
...
var byteArrayEqual = function(b1, b2) {
...
var readLead = function(lead) {
  ...
  if (!byteArrayEqual(leadMagic, lead)) {
    throw new TypeError("Bad magic, this is not a lead. Expecting " + leadMagic + " but got " + lead);
  }
  return {
...
var storeSize = function(indices) {
  ...
  // Return largest offset + count for this entry % 4
  return maxOff + n;
};
...
exports.byteArrayEqual = byteArrayEqual;
...
exports.oneIndexSize = oneIndexSize;